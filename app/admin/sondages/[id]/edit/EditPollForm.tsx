        ...
        <div className="rounded-md border border-line dark:border-night-line bg-paper dark:bg-night-2 p-6 sm:p-8 space-y-5">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-2 border-b border-line dark:border-night-line">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-sm border border-brand/30 bg-brand/5 hover:bg-brand/10 px-3.5 py-2 text-xs font-semibold uppercase tracking-wider text-brand transition-colors duration-150 disabled:opacity-50 min-h-[44px] cursor-pointer"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label htmlFor="poll-edit-weekend-date" className="block text-xs font-semibold text-ink-2 dark:text-snow-2 mb-1">
            ...
            <div>
              <label htmlFor="poll-edit-status" className="block text-xs font-semibold text-ink-2 dark:text-snow-2 mb-1">
                Statut du sondage *
              </label>
              <select
                id="poll-edit-status"
          ...
          <div>
            <label htmlFor="poll-edit-title" className="block text-xs font-semibold text-ink-2 dark:text-snow-2 mb-1">
              Titre du sondage *
            </label>
            <input
              id="poll-edit-title"
          ...
          <div>
            <label htmlFor="poll-edit-description" className="block text-xs font-semibold text-ink-2 dark:text-snow-2 mb-1">
        ...
        <div className="rounded-md border border-line dark:border-night-line bg-paper dark:bg-night-2 p-6 sm:p-8 space-y-6">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-sm border border-line dark:border-night-line bg-paper-2 dark:bg-night px-4 py-2 text-xs font-semibold text-ink dark:text-snow-1 hover:bg-paper-3 dark:hover:bg-night-line transition-colors duration-150 min-h-[44px] cursor-pointer"
            >
