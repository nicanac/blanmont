        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="p-3.5 rounded-lg border border-night-line bg-night-2 space-y-1">
              ...
              <p className="text-snow-3 text-xs">Samedi matin, Dimanche matin, Les deux jours, ou Absent.</p>
            </div>

            <div className="p-3.5 rounded-lg border border-night-line bg-night-2 space-y-1">
              <h4 className="font-bold text-white text-xs">Groupe de Niveau</h4>
              <p className="text-snow-3 text-xs">Groupe A (&gt;30 km/h), Groupe B (27-29 km/h), Groupe C (24-26 km/h) ou VTT.</p>
            </div>
          </div>
        </div>
      ),
