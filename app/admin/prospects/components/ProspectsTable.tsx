                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 sm:px-6 py-3.5 whitespace-nowrap">
                        ...
                        <div className="text-xs text-ink-3 dark:text-snow-3 truncate max-w-[200px]">
                          {p.email}
                        </div>
                      </td>
                      ...
                      >
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="text-xs tabular-nums text-ink-3 dark:text-snow-3 ml-1 font-mono">
                            {p.phone}
                          </span>
                        </div>
                      </td>
                      ...
                      <td className="px-4 sm:px-6 py-3.5 whitespace-nowrap">
                        <div className="flex items-center gap-1.5 flex-wrap">
                          <span
                            className={`inline-flex items-center rounded-full px-2 py-0.5 text-xs font-bold border ${groupInfo.classes}`}
                          >
                            {groupInfo.label}
                          </span>
                          <span className="inline-flex items-center rounded-sm bg-paper dark:bg-night-3 px-1.5 py-0.5 text-xs font-semibold text-ink-3 dark:text-snow-3 border border-line dark:border-night-line">
                            {p.bikeType}
                          </span>
                        </div>
                      </td>
                      ...
                      <td className="px-4 sm:px-6 py-3.5 whitespace-nowrap text-ink-3 dark:text-snow-3">
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="tabular-nums font-semibold text-ink dark:text-white font-mono">
                      ...
                      <td className="px-4 sm:px-6 py-3.5 whitespace-nowrap">
                        <span
                          className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-bold uppercase tracking-wider border ${statusInfo.classes}`}
                        >
                          {statusInfo.label}
                        </span>
                      </td>
