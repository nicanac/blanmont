...
export default function StatsAgSummary({ stats }: StatsAgSummaryProps): React.ReactElement {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 rounded-lg border border-[#e4e0d8] bg-white p-5 shadow-xs">
        <div>
          ...
          <h2 className="mt-2 text-xl font-extrabold uppercase tracking-tight text-[#101216]">
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          <button
            ...
            className="inline-flex items-center gap-2 rounded-md border border-[#e4e0d8] bg-[#faf8f5] px-3.5 py-2 text-xs font-bold uppercase tracking-wider text-[#101216] hover:bg-[#f2efe9] hover:border-[#101216]/30 transition-colors shadow-xs active:scale-98"
          ...
          <button
            type="button"
            onClick={handlePrint}
            className="inline-flex items-center gap-2 rounded-md bg-[#101216] px-4 py-2 text-xs font-bold uppercase tracking-wider text-white hover:bg-[#262b38] transition-colors shadow-xs active:scale-98"
      ...
      <div className="rounded-lg border border-[#e4e0d8] bg-white p-6 sm:p-8 shadow-xs space-y-8 print:border-none print:shadow-none print:p-0">
        {/* Editorial Header */}
        <div className="border-b border-[#e4e0d8] pb-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-bold uppercase tracking-wider text-[#e03e3e]">
                CC Saint-Martin Blanmont
              </p>
              <h1 className="text-2xl font-extrabold text-[#101216]">
                Rapport Statistique d&apos;Activité &amp; Bilan Sportif
              </h1>
            </div>
            <div className="text-right">
              <p className="text-xs font-semibold text-[#5c6370]">Année Officielle</p>
              <p className="text-lg font-extrabold text-[#101216] tabular-nums">
                {stats.selectedYear}
              </p>
            </div>
          </div>
        ...
        <section className="space-y-4">
          <h3 className="text-sm font-extrabold uppercase tracking-tight text-[#101216] flex items-center gap-2">
        ...
        <section className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {stats.carreVert.podium.map((p) => (
              <div
                key={p.rank}
                className="rounded-md border border-[#e4e0d8] bg-white p-4 relative overflow-hidden"
              >
                <div className="flex items-center justify-between">
                  <span
                    className={`inline-flex items-center rounded-full px-2 py-0.5 text-xs font-bold ${
                      p.rank === 1
                        ...
                        : p.rank === 2
                        ? 'bg-[#f2efe9] text-[#3a3f4a] border border-[#c9c4ba]'
                ...
                <p className="mt-3 text-base font-extrabold text-[#101216]">
                  {p.name}
                </p>
                <p className="mt-1 text-xs font-bold text-[#101216] tabular-nums">
          ...
          {/* Merit Tiers Summary */}
          <div className="rounded-md border border-[#e4e0d8] bg-[#faf8f5] p-4">
            <p className="text-xs font-bold uppercase tracking-wider text-[#5c6370] mb-3">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 text-center">
              ...
              <div className="rounded-sm border border-[#e4e0d8] bg-white p-2.5">
                <span className="text-xs font-bold uppercase text-[#5c6370]">
                  Peloton (20-39%)
                </span>
                <p className="mt-1 text-xl font-extrabold text-[#101216] tabular-nums">
        ...
        <section className="space-y-4">
          <h3 className="text-sm font-extrabold uppercase tracking-tight text-[#101216] flex items-center gap-2">
            <CheckBadgeIcon className="h-4 w-4 text-[#10b981]" />
            <span>3. Patrimoine Routier &amp; Démocratie du Club</span>
          </h3>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="rounded-md border border-[#e4e0d8] bg-[#faf8f5] p-4 space-y-2">
              <p className="text-xs font-bold uppercase tracking-wider text-[#5c6370]">
                Catalogue des Parcours &amp; Qualité
              </p>
              <ul className="text-xs text-[#101216] space-y-1">
        ...
        <div className="pt-6 border-t border-[#e4e0d8] flex flex-col sm:flex-row sm:items-center sm:justify-between text-xs text-[#5c6370]">
          <p>
            Validé pour l&apos;Assemblée Générale statutaire du CC Saint-Martin Blanmont.
          </p>
          <p className="font-semibold text-[#101216]">
