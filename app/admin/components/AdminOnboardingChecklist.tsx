...
export default function AdminOnboardingChecklist({
  ...
  const steps: StepItem[] = [
    ...
    {
      id: 'gear_and_traces',
      title: 'Catalogue Gobik & Traces GPS',
      category: 'Opérations',
      description:
        'Gérez le stock de tenues officielles du club et enrichissez la bibliothèque de parcours GPX avec profil altimétrique.',
      tip: 'Les membres peuvent télécharger les fichiers GPX directement sur leur compteur Garmin ou Wahoo.',
      href: '/admin/traces',
      actionLabel: 'Explorer les traces & équipements',
      icon: MapIcon,
      autoCompleted: false,
