...
const COMMAND_ITEMS: CommandItem[] = [
  ...
  },
  {
    ...
    href: '/admin/traces',
    icon: MapIcon,
    keywords: ['traces', 'parcours', 'gpx', 'strava', 'komoot', 'map', 'carte'],
  },
  {
    id: 'page-carre-vert',
  ...
  },
  {
    ...
    category: 'Actions Rapides',
    description: 'Combiner plusieurs fichiers GPX en un seul itinéraire',
    href: '/admin/traces/merge',
    icon: DocumentArrowUpIcon,
    keywords: ['fusionner', 'combiner', 'merge', 'gpx', 'trace', 'parcours'],
  },
  {
