  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-[#101216] dark:text-white">Nouvel Événement</h1>
          <p className="text-sm text-[#5c6370] dark:text-[#a7adbb]">Ajouter une sortie au calendrier</p>
        </div>
      </div>
