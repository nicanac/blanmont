        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4">
            {[
              ...
              <div
                key={step.num}
                className="flex items-start gap-3.5 p-3.5 rounded-lg border border-night-line bg-night-2"
              >
                <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-brand text-white font-extrabold text-xs">
                  {step.num}
                </div>
                <div className="space-y-1">
                  <h4 className="font-bold text-white text-sm">{step.title}</h4>
                  <p className="text-snow-3 text-xs leading-relaxed">{step.desc}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="space-y-4">
          <div className="rounded-lg border border-night-line bg-night-2 p-4 text-xs text-snow-3 space-y-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
              <div className="p-2.5 rounded bg-night border border-night-line space-y-1">
                <span className="font-bold text-white text-xs">Titres H2 &amp; H3</span>
                <p className="text-ink-3 text-xs">Idéal pour découper les longs récits en sections lisibles.</p>
              </div>
              <div className="p-2.5 rounded bg-night border border-night-line space-y-1">
                <span className="font-bold text-white text-xs">Listes à puces &amp; numérotées</span>
                <p className="text-ink-3 text-xs">Pour lister les consignes, les horaires ou les inscrits.</p>
              </div>
              <div className="p-2.5 rounded bg-night border border-night-line space-y-1">
                <span className="font-bold text-white text-xs">Liens externes &amp; GPX</span>
                <p className="text-ink-3 text-xs">Liez directement vers des parcours Strava, Komoot ou Google Maps.</p>
              </div>
              <div className="p-2.5 rounded bg-night border border-night-line space-y-1">
                <span className="font-bold text-white text-xs">Images intégrées</span>
                <p className="text-ink-3 text-xs">Insérez des visuels et photos au fil du texte.</p>
              </div>
            </div>
          </div>
      ...
      content: (
        <div className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="p-3.5 rounded-lg border border-night-line bg-night-2 space-y-1.5">
