...
export default function EditorialGazetteSection({ posts }: EditorialGazetteSectionProps) {
  ...
  return (
    <section className="py-24 sm:py-32 bg-[#faf8f5] dark:bg-[#0a0c10] text-[#101216] dark:text-[#f5f6f8] border-b border-[#e4e0d8] dark:border-[#262b38] relative">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-12 sm:space-y-16">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-[#e4e0d8] dark:border-[#262b38] pb-8">
          ...
          <Link
            href="/blog"
            className="inline-flex items-center gap-2 rounded-md border border-[#e4e0d8] dark:border-[#262b38] bg-white dark:bg-[#161922] px-5 py-3 text-xs font-bold uppercase tracking-wider text-[#101216] dark:text-[#f5f6f8] hover:border-[#101216]/40 dark:hover:border-white/40 transition-colors duration-150 shadow-xs"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <Link
            ...
            className="group relative lg:col-span-7 overflow-hidden rounded-xl bg-[#0a0c10] border border-[#e4e0d8] dark:border-[#262b38] min-h-[420px] sm:min-h-[520px] flex flex-col justify-end shadow-xl hover:shadow-2xl transition-all duration-200 ease-out"
          >
            <Image
            ...
            <div className="relative z-10 p-6 sm:p-10 space-y-3">
              <h3 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold tracking-tight leading-tight text-white group-hover:text-[#e03e3e] transition-colors duration-150">
                {featured.title}
              </h3>
              ...
              <div className="pt-2 flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-white group-hover:text-[#e03e3e] transition-colors duration-150">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between space-y-4">
            <div className="border-t border-[#e4e0d8] dark:border-[#262b38] divide-y divide-[#e4e0d8] dark:divide-[#262b38]">
              {secondary.map((post) => (
                <Link
                  key={post.id}
                  href={`/blog/${post.slug}`}
                  className="group block py-6 hover:bg-white/80 dark:hover:bg-[#161922] transition-colors duration-150 px-4 -mx-4 rounded-lg"
                >
                  <h4 className="text-lg sm:text-xl font-bold tracking-tight text-[#101216] dark:text-white group-hover:text-[#e03e3e] transition-colors duration-150 leading-snug">
                    {post.title}
                  </h4>

                  <div className="mt-1.5 flex items-center gap-2 text-xs text-[#5c6370] dark:text-[#a7adbb]">
                    <span className="font-semibold text-[#e03e3e]">{post.category}</span>
                    <span>•</span>
                    <span>{formatDate(post.publishedAt)}</span>
                  </div>

                  <p className="mt-2 text-xs sm:text-sm text-[#5c6370] dark:text-[#a7adbb] line-clamp-2 leading-relaxed">
                    {post.excerpt}
                  </p>
            ...
            <div className="rounded-lg bg-white dark:bg-[#161922] border border-[#e4e0d8] dark:border-[#262b38] p-5 flex items-center justify-between">
              ...
              <Link
                ...
                className="text-xs font-bold uppercase tracking-wider text-[#e03e3e] hover:underline transition-colors duration-150"
              >
                Équipements →
              </Link>
            </div>
