...
export default function BlogList({ posts }: BlogListProps): React.ReactElement {
  ...
  if (posts.length === 0) {
    return (
      <div className="rounded-lg border border-[#e4e0d8] dark:border-[#262b38] bg-white dark:bg-[#161922] p-12 sm:p-16 text-center space-y-3">
        <NewspaperIcon className="mx-auto h-12 w-12 text-[#5c6370] dark:text-[#a7adbb]" aria-hidden="true" />
        <h3 className="text-base font-bold text-[#101216] dark:text-white">Aucun article publié</h3>
  ...
  return (
    <div className="space-y-8">
      {/* ──── Filter & Search Bar ──── */}
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 p-4 sm:p-5 rounded-lg border border-[#e4e0d8] dark:border-[#262b38] bg-white dark:bg-[#161922] shadow-xs">
        {/* Search input */}
        <div className="relative flex-1 max-w-md">
          <MagnifyingGlassIcon className="pointer-events-none absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-[#5c6370] dark:text-[#a7adbb]" aria-hidden="true" />
          <input
            type="text"
            value={search}
            ...
            className="w-full min-h-[44px] rounded-md border border-[#e4e0d8] dark:border-[#262b38] bg-[#faf8f5] dark:bg-[#1d2128] pl-10 pr-12 py-2.5 text-xs sm:text-sm text-[#101216] dark:text-white placeholder:text-[#5c6370] dark:placeholder:text-[#a7adbb] focus:border-[#e03e3e] focus:bg-white dark:focus:bg-[#161922] focus:outline-hidden focus-visible:ring-2 focus-visible:ring-[#e03e3e] transition-colors"
          />
          {search && (
            <button
              type="button"
      ...
      {filteredPosts.length > 0 ? (
        ...
        /* Empty State */
        <div className="rounded-lg border border-[#e4e0d8] dark:border-[#262b38] bg-white dark:bg-[#161922] p-12 text-center space-y-4">
          <NewspaperIcon className="mx-auto h-12 w-12 text-[#5c6370] dark:text-[#a7adbb]" aria-hidden="true" />
          <h3 className="text-base font-bold text-[#101216] dark:text-white">Aucun article trouvé</h3>
