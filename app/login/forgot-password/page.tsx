  ...
  return (
    <main className="dark relative flex min-h-[85vh] items-center justify-center overflow-hidden bg-night px-4 py-12 text-white [--sheet:1700px] sm:px-6 sm:[--sheet:2400px] lg:px-8">
      ...
      <div className="w-full max-w-md relative z-10 space-y-6">
        {/* Card */}
        <div className="neatline bg-night-2/95 p-8 sm:p-10 shadow-2xl space-y-6">
          <div className="text-center space-y-2">
            <h1 className="text-2xl sm:text-3xl font-extrabold uppercase tracking-tight text-white">
              Activer ou Réinitialiser votre mot de passe
            </h1>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-md border border-night-line bg-ink pl-10 pr-4 py-3 text-xs sm:text-sm text-white placeholder:text-snow-3 focus:border-brand focus:outline-none transition-colors"
                />
              </div>
            </div>
            ...
            <div className="pt-2">
              <button
                ...
                className="w-full inline-flex items-center justify-center gap-2 rounded-md bg-brand hover:bg-brand-strong text-white px-6 py-3.5 text-xs font-semibold uppercase tracking-wider transition-colors active:scale-[0.98] shadow-lg disabled:opacity-50 min-h-[44px]"
              >
                {isSubmitting ? (
                  <>
          ...
          <div className="pt-4 border-t border-night-line text-center">
            <Link
              href="/login"
