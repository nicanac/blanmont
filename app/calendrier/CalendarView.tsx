        ...
        <div className="pt-3 border-t border-[#e4e0d8] dark:border-[#262b38] space-y-2.5">
          ...
          <div className="grid grid-cols-2 sm:flex sm:flex-wrap items-center gap-2">
            ...
            <button
              ...
              disabled={filterCounts.saturday === 0}
              className={cn(
                'min-h-[44px] px-3 sm:px-4 py-2 rounded-md text-xs font-semibold transition-all flex items-center justify-center gap-1.5 cursor-pointer border',
                filterType === 'saturday'
            ...
            <button
              ...
              disabled={filterCounts.sunday === 0}
              className={cn(
                'min-h-[44px] px-3 sm:px-4 py-2 rounded-md text-xs font-semibold transition-all flex items-center justify-center gap-1.5 cursor-pointer border',
                filterType === 'sunday'
                  ? 'bg-[#e03e3e] text-white border-[#e03e3e] shadow-2xs'
            ...
            >
              ...
              <span className="sm:hidden">Trace GPX</span>
            ...
            {/* Desktop Reset link if filter is active */}
            {filterType !== 'all' && (
              <button
                type="button"
                onClick={() => setFilterType('all')}
                          ...
                          return (
                            ...
                            >
                              <div className="flex items-center justify-between gap-1">
                                ...
                                {event.departure && (
                                  <span className="hidden sm:inline text-xs font-semibold tabular-nums opacity-90 shrink-0">
                                    {event.departure}
                                  </span>
                                )}
                              </div>
