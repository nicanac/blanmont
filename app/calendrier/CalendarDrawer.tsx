    ...
    >
      ...
      <div className="fixed inset-y-0 right-0 flex max-w-full pl-0 sm:pl-10">
        <div className="w-screen max-w-full sm:max-w-xl lg:max-w-2xl bg-white dark:bg-[#161922] shadow-2xl flex flex-col animate-in slide-in-from-right duration-300 border-l border-[#e4e0d8] dark:border-[#262b38]">
          ...
          <div className="relative bg-[#101216] text-white p-4 sm:p-6 border-b border-[#262b38] overflow-hidden shrink-0">
            ...
            <div className="relative z-10 flex items-start justify-between gap-3 sm:gap-4">
              <div className="space-y-1.5 sm:space-y-2 min-w-0 flex-1">
                ...
                <h2
                  id="drawer-title"
                  className="text-lg sm:text-2xl lg:text-3xl font-extrabold uppercase tracking-tight text-white font-display break-words line-clamp-2"
                >
                  {event.location}
                </h2>
          ...
          <div className="flex-1 overflow-y-auto overscroll-contain [scrollbar-width:thin] [scrollbar-color:rgba(156,163,175,0.3)_transparent] p-3 sm:p-6 space-y-3 sm:space-y-6">
              ...
              <div className="space-y-3 sm:space-y-6 animate-in fade-in duration-200">
                ...
                {(event.remarks || event.alternative) && (
                  <div className="space-y-2.5 sm:space-y-3">
                    ...
                    {event.alternative && (
                      <div className="rounded-lg border border-amber-200 dark:border-amber-900/40 bg-amber-50/50 dark:bg-amber-950/20 p-4 sm:p-5 space-y-2">
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 sm:gap-3">
                              ...
                              {/* Star Rating Display */}
                              <div className="flex items-center gap-1 shrink-0 self-start sm:self-auto pt-0.5 sm:pt-0">
                                {[1, 2, 3, 4, 5].map((star) => (
                                  <StarIcon
                                    key={star}
                                    className={`h-4 w-4 ${
