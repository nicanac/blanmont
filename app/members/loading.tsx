  ...
  return (
    <main className="min-h-screen bg-[#faf8f5] dark:bg-[#0a0c10] animate-pulse transition-colors duration-200">
      ...
      <section className="max-w-7xl mx-auto px-4 py-8 sm:px-6 sm:py-12 lg:px-8 space-y-8">
        <div className="h-14 w-full rounded-lg border border-[#e4e0d8] dark:border-[#262b38] bg-white dark:bg-[#101216] p-4" />
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {Array.from({ length: 8 }).map((_, i) => (
            <div key={i} className="rounded-lg border border-[#e4e0d8] dark:border-[#262b38] bg-white dark:bg-[#101216] overflow-hidden space-y-4 pb-4">
              <div className="aspect-[4/5] bg-[#f2efe9] dark:bg-[#1c202a]" />
              <div className="p-4 space-y-2">
                <div className="h-5 w-3/4 bg-[#f2efe9] dark:bg-[#1c202a] rounded" />
                <div className="h-3 w-1/2 bg-[#f2efe9] dark:bg-[#1c202a] rounded" />
              </div>
            </div>
          ))}
        </div>
